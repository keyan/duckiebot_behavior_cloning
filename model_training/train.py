...
def train(args):
    ...
    for epoch in tqdm(range(args.epochs)):
        ...
        tb_writer.add_scalar('Validation/train/linear', validation_accuracy_lin_pct, epoch)
        tb_writer.add_scalar('Validation/train/angular', validation_accuracy_ang_pct, epoch)
